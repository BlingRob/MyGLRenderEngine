...
struct STB_Loader
{
		...
		STB_Loader(void* path, std::size_t width, std::size_t height, bool FromProc) { LoadTexture(path,width,height,FromProc); }
		...
		void LoadTexture(void* path, std::size_t width, std::size_t height, bool FromProc);
